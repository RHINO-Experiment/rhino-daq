...
class VNA:
    ...
    def get_s11_measurements(self, min_freq=60e6, max_freq=80e6, n_integrations=5):
        ...
        vna.set_sweep(start=500e3, stop=600e3)
        vna.set_frequencies(start=500e3, stop=600e3)
        vna.pause()
...
class MultiFrequencyObserver:
    ...
    def begin_observations_no_vna(self, obs_title=None):
        date_string = datetime.now().strftime("%Y_%m_%d")
        time_string = datetime.now().strftime("%H%M%S")
        save_file = h5py.File(self.save_folder+date_string+"no_vna.hdf5" ,'a')
        int_time_per_freq = timedelta(seconds=self.integration_time_per_frequency)
        epoch = datetime.now()
...
if __name__ == '__main__':
    switch_dictionary = {"vna_short":"1_1_7",
                        ...
                        "vna_antenna":"1_1_1",
                        "vna_load_term":"1_1_2",
                        "vna_noise_diode":"1_1_4",
                        "rec_antenna":"1_2_1",
                        "rec_load_term":"1_2_2",
                        "rec_noise_diode":"1_2_4",
                        "vna_rec":"2_2_8"
                        }
    ...
    observer.begin_observations_no_vna()